...
def SendDirect(request):
    ...
    if request.method == "POST":
        try:
            ...
            messages.warning(request, f"User with username '{to_user_username}' does not exist.")
            return redirect('message')  # You can adjust the redirect URL accordingly
...
def NewConversation(request, username):
    ...
    try:
        ...
        return redirect('search-users')  # You can adjust the redirect URL accordingly
